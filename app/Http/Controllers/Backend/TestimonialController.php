    ...
    public function getData(Request $request)
    {
        ...
        return DataTables::of($testimonials)
             ...
             ->addColumn('image', function ($testimonial) {
                return '<img src="'. asset($testimonial->image) .'" alt="" style="width: 65px;">';
             })
             ->addColumn('review_ratings', function ($testimonial) {
                return '<span class="badge bg-primary mb-2"> '.$testimonial->review_ratings.' </span> <br/>';
            })
