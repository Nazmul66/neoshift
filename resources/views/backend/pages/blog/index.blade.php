    ...
    <div class="card">
        ...
        <div class="card-body">
          <div class="table-responsive text-nowrap">
            <table class="table table-bordered" id="blogTables">
              <thead>
                <tr>
                  <th>#SL.</th>
                  <th>Image</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <label for="up_title" class="form-label">Blog Title</label>
                            <input type="text" id="up_title" name="title" class="form-control" placeholder="Blog Title">
                        </div>
...
@push('add-js')
 ...
 <script>
     ...
     $(document).ready(function(){
        ...
        // show all data
        let blogTables = $('#blogTables').DataTable({
            order: [
                [0, 'asc']
            ],
            processing: true,
